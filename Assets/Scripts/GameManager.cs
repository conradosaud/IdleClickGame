...
public class GameManager : MonoBehaviour
{
    ...
    public static void SalvarJogo()
    {
        ...
        PlayerPrefs.SetInt("clicador", clicadores);
        PlayerPrefs.SetInt("multiplicadores", multiplicadores);
        PlayerPrefs.Save();
        ToastNotification.Show("Jogo Salvo com sucesso!");
    }
    ...
    public void CarregarJogo()
    {
        ...
        dinheiro = PlayerPrefs.GetInt("dinheio");
        clicadores = PlayerPrefs.GetInt("clicador");
